            ...
            for i, (images, _) in enumerate(train_loader):
                ...
                if ((i + 1) % 100) == 0:
                    ...
                    for tag, value in info.items():
                        self.logger.scalar_summary(tag, float(value), generator_iter)
                    ...
                    #print(images.shape)
                    #print(self.real_images(images, self.number_of_images).shape)
                    #print(z.shape)
                    #print(self.generate_img(z, self.number_of_images).shape)
